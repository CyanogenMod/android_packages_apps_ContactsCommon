...
public class LookupProviderImpl implements LookupProvider {
    ...
    private LookupProviderImpl(Context context) {
        ...
        if (AmbientConnectionManager.isAvailable(mContext)) {
            ...
            mProviderUpdateListener = new ProviderUpdateListener(mContext, new ProviderUpdateListener.Callback() {
                @Override
                public void onProviderChanged(ProviderInfo providerInfo) {
                    boolean isProviderEnabled;
                    if (providerInfo != null && providerInfo.getStatus() == PluginStatus.ACTIVE) {
