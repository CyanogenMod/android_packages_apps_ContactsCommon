...
public class ContactListItemView extends ViewGroup
    ...
    private int mSelectedPhotoBackgroundColor;
    ...
    public ContactListItemView(Context context, AttributeSet attrs) {
        ...
        mSelectedPhotoBackgroundColor = a.getColor(R.styleable.Theme_android_colorPrimary, 0);
        a.recycle();
    ...
    public QuickContactBadge getQuickContact() {
        ...
        if (mQuickContact == null) {
            ...
            mQuickContact.setCheckMarkBackgroundColor(mSelectedPhotoBackgroundColor);
    ...
    public ImageView getPhotoView() {
        if (mPhotoView == null) {
            ...
            mPhotoView.setCheckMarkBackgroundColor(mSelectedPhotoBackgroundColor);
