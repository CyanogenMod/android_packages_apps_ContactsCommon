...
import com.android.contacts.common.model.DirectoryId;
import com.android.contacts.common.model.dataitem.IdentityDataItem;
...
public class ContactBuilder {
    ...
    public Contact build() {
        ...
        try {
            ...
            // TODO STORE THIS
            //contactToReturn.normalizedNumber = mNormalizedNumber;

            /*
            contactToReturn.number = mPhoneNumbers.get(0).number;
            contactToReturn.type = mPhoneNumbers.get(0).type;
            contactToReturn.label = mPhoneNumbers.get(0).label;
            if (mAddresses.size() > 0) {
                Address addr = mAddresses.get(0);
                if (addr != null) {
                    contactToReturn.region =
                            addr.city != null ? addr.city : addr.region;
                }
            }
            contactToReturn.photoUri = mPhotoUri != null ? mPhotoUri : null;
            ...
            String json = new JSONObject()
                    ...
                    .put(Contacts.CONTENT_ITEM_TYPE, contactToReturn)
                    .toString();
